...
export default function ConstitutionPage() {
  return (
    <AppShell current="repos">
      <PageHeader eyebrow="Aegisure.md" title="Project Constitution editor">
      ...
      <div className="grid gap-6 p-6 md:grid-cols-[minmax(0,1fr)_360px] md:p-10">
        <Card>
          <SectionHeader eyebrow="Canonical memory" title="Aegisure.md" description="Aegisure keeps one source of truth and exports it into the files real coding agents already read." />
          <textarea
            ...
            placeholder="Generate Aegisure.md from a connected repository to edit live project rules here."
            aria-label="Aegisure.md editor"
          />
        </Card>
        <Card>
          ...
          <div className="mt-5 space-y-3 text-sm text-muted-foreground">
            <p className="rounded-xl border border-border bg-muted/25 p-3">Canonical file: Aegisure.md</p>
